...
<html>
    ...
    <body style = "text-align : CENTER"><nav class="navbar navbar-default">
...
<?php
    ...
    if((!isset($_SESSION['username']))||($news_user_id!=$user_id)){
    echo "<p><strong>You are not logged in, or you are not allowed to delete this.</strong></p>";
    echo "<br><a href='login.php'><input type='button'value='Login'></a>";
    }else{
$username = $_SESSION['username'];
$user_id = (integer)$_POST['news_user_id'];
$user_id = $_SESSION['user_id'];
...
printf("<br><strong>Comment deleted!</strong><br />");
